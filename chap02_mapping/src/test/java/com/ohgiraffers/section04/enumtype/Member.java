...
//    @Enumerated(EnumType.ORDINAL) // index 값으로 입력
    @Enumerated(EnumType.STRING)    // 문자 값으로 입력
    ...
    public Member(int memberNo, String memeberId, String memberPwd, String nickname, String phone, String email, Date enrollDate, String address, RoleType memberRole, String status) {
